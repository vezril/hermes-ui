/**
 * Hermes-managed inspector subscriptions (playground tap): a Hermes-owned
 ...
 */
export const INSPECTOR_PREFIX = "hermes-inspector";
...
/** Whether a subscription id is a Hermes inspector sub (any inspector prefix form). */
