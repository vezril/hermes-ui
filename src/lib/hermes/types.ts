/**
 * The HermesMQ surface Hermes consumes, as browser-facing DTOs. HermesMQ is
...
export const TAP_ORIGIN_ATTR = "x-hermes-tap-origin";
...
/** grpc.health.v1-style status, surfaced by the /health BFF route. */
